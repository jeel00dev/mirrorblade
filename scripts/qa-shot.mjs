...
if (has('play') || screen === 'pause' || screen === 'gameover' || flag('state')) {
  ...
  if (screen === 'gameover') { await page.evaluate(() => { const t = window.__MIRRORBLADE_TEST__; t.game.debugSetScore(13410); t.endRun(); }); await page.waitForTimeout(1300); }
} else if (screen) {
